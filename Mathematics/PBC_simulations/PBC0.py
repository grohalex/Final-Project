# older version densities0 which I will modify to get
...
#parameters
N = 5     # number of sites
rho_t = 1.2 #total fraction of particles in the system -> from 0 (empty) to 2 (both lattices are full)
...
steps = 4000         #steps
steady_state = 3000  #after the transient phase
