...
#rho = np.linspace(0,2,100) #particles in the first
#gamma =
...
steps = 30000        #steps
steady_state = 12000  #after the transient phase
...
Name = "PBC_currents_N%sSteps%s"%(N, len(rho_t))
heading = "sites: N%s, total steps: %s, steady_state: %s "%(N, steps, steady_state)#" \t  \t "
