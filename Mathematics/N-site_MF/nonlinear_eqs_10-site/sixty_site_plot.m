function sixty_site_plot(sim1, sim2)
a = 0.4; %to print the pars
b = 1; %adjust
x = fsolve(@sixty_site,rand(1,119));   %to solve the equations given by ftion ten_site

xs = x(1:60);           %lattice 1 average occupancies
ys = [0 x(61:end)];     %lattice 2 average occupancies
