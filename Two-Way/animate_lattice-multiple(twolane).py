...
a1_vec = [1, 1, 1 , 1]      # injection probability at lattice 1
a2_vec = [0,0,0,0]      # injection probability at lattice 2
b1_vec = [1,1,1,1]      # removal probability at lattice 1
b2_vec = [1,1,1,1]      # removal probability at lattice 2
k11_vec = [1,1,1,1]     # steping probability for particle 1 in lattice 1
k12_vec = [0.1,0.2,0.6,1]    # steping probability for particle 1 to lattice 2
