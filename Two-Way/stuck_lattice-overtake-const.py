...
plt.title("Stuck Lattice heatmap(number of sites = %s, resolution in k12 = %s, k21 = %s, \n parameters: parameters: a1=%s, b1=%s, a2=%s, b2=%s, k11=%s, k22=%s)"%(N, len(k12_values), len(k21_values), a1, b1, a2, b2, k11, k22))
