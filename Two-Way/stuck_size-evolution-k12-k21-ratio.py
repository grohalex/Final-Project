...
b2 = 0.2      # removal probability at lattice 2
k11 = 1    # steping probability for particle 1 in lattice 1
k12 = [round(i,2) for i in np.linspace(0.05,0.5, 9)]   # steping probability for particle 1 to lattice 2
k21 = np.multiply(k12,2)    # steping probability for particle 2 to lattice 1
